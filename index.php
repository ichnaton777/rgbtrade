...
/************************************************************
 * 
 * Main index.php file for this system
 *
 * @package Rgbtrade
 * @author Barry Voeten, Kleureneconomie
 * @version 0.40
 * @year 2008-2012
 * @title Rainbow Trading
 * @full name Barry Voeten. Stichting Kleureneconomie
 * @first author Barry Voeten
 * @copyright GPL
 **/
